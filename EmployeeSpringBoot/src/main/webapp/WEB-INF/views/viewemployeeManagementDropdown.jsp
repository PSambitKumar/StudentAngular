    ...
    <div class="row" >
        <div class="col-xs-6">
            <div class="dataTables_length form-inline" id="">
                <label>Display
                    <select name="dynamicTable_length" aria-controls="dynamicTable" class="form-control input-sm" id="dropDownPageSize">
                        <c:forEach var="i" begin="1" end="${totalDropdown}">
...
<script>
    ...
    $('#dropDownPageSize').on("change", function (){
